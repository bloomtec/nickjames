<div id="<?php print $group ?>-section" class='parallax-section'>
    <div class="parallax-content">
        ...
        <?php if(isset($fields['body']) &&  !empty($fields['body'])): ?>
           ...
           <div class="view-full">
                <a  class="colorbox-load kalei-load" href="/category_list?width=807&height=784&iframe=true"></a>
                <a  class="colorbox-load" href="/category_list?width=807&height=784&iframe=true">
    ...
    <div class="kaleidoscope-parallax <?php echo "kaleidoscope_1" ?>"> 
        <img  src="<?php  print $base_path.path_to_theme(); ?>/images/collection_kaleidoscope_1.png" />
    </div>
    <div class="kaleidoscope-parallax <?php echo "kaleidoscope_2" ?>"> 
        <img   src="<?php  print $base_path.path_to_theme(); ?>/images/collection_kaleidoscope_2.png" />
    </div>
    <div class="kaleidoscope-parallax <?php echo "kaleidoscope_3" ?> shadown1"> 
        <img  src="<?php  print $base_path.path_to_theme(); ?>/images/collection_kaleidoscope_3.png" />
    </div>
    <div class="kaleidoscope-parallax <?php echo "kaleidoscope_4" ?> shadown1"> 
        <img  src="<?php  print $base_path.path_to_theme(); ?>/images/collection_kaleidoscope_4.png" />
    </div>
    ...
    <?php  foreach($fields['product'] as $id => $product): ?>
        ...
        <div class="product-parallax <?php echo $group."_product_".$id ?>"> 
            ...
            <?php if(in_array($id, array(1,3,4))): ?>
